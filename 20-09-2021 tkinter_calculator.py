...
##win.configure(width=300,height=400,background='red')
...
entry.grid(row=0,columnspan=4,sticky='nsew')   #nsew=north south east west
...
button_b=ttk.Button(win,text='=',command=equal)
button_b.grid(row=5,columnspan=4,sticky='nsew')
